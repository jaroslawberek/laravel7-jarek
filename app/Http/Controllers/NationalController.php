...
class NationalController extends Controller
{
    ...
    {
        //$crudTable = view("admin.crud_table.nations_table");        
        return view("admin.nations_table",['title'=>'Państewka', 
                                              'routeCreate'=>"nationals.create", 
